...
srcObjects = $(addprefix $(buildDir_CustomAssert)/, $(sources:.cpp=.o))
...
$(srcObjects): $(buildDir_CustomAssert)/%.o: $(srcDir)/%.cpp
	@echo [CXX] -c $< -o $@
	@$(CXX) $(CXXFLAGS) -c $< -o $@

prepare:
	@mkdir -p $(buildDir_CustomAssert)
